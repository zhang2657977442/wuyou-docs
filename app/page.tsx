  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center">
          <div className="mr-4 flex items-center gap-2 md:mr-6">
            <Image src="/images/logo.png" alt="无忧直聘 Logo" width={28} height={28} className="h-7 w-7" />
          ...
          <nav className="flex flex-1 items-center justify-between space-x-2 md:justify-end md:space-x-4">
            <div className="hidden md:flex md:items-center md:gap-6">
              ...
              <ScrollLink href="#screenshots" className="text-sm font-medium transition-colors hover:text-primary">
                项目截图
              </ScrollLink>
              <ScrollLink href="#contact" className="text-sm font-medium transition-colors hover:text-primary">
                联系方式
              </ScrollLink>
            </div>
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">无忧直聘小程序</h1>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32" id="features">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm">功能模块</div>
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">丰富的招聘求职功能</h2>
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-center text-muted-foreground">招聘者可以发布职位信息，设置薪资、要求等</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-center text-muted-foreground">求职者可以创建个人简历，展示自己的技能和经验</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-center text-muted-foreground">招聘者可以创建和管理公司信息</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-center text-muted-foreground">利用GoEasy实现求职者与招聘者的即时沟通</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-center text-muted-foreground">利用腾讯位置服务实现地理位置相关功能</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-center text-muted-foreground">可在求职者和招聘者角色之间自由切换</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-center text-muted-foreground">支持收藏岗位和收藏简历功能</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-center text-muted-foreground">查看谁浏览过你的简历或职位信息</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-center text-muted-foreground">接收应用重要更新和活动的系统通知</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-muted" id="screenshots">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">项目截图</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  无忧直聘小程序界面展示
                </p>
              </div>
            ...
            <div className="overflow-hidden rounded-xl border bg-background shadow-xl flex items-center justify-center p-2">
                <div className="relative w-full" style={{ maxWidth: "1280px", margin: "0 auto" }}>
                  <Image
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-muted/50" id="contact">
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">项目列表</h2>
                ...
                <ul className="grid gap-6">
                  <li className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                      <p className="text-lg font-medium leading-none">无忧直聘前端(Uni-app+Vue2)</p>
                  ...
                  <li className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">收费，个人从零开发</p>
                    </div>
                  </li>
                  <li className="flex items-center gap-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">联系方式</h2>
                  <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    如需后端和管理端源码请联系
                  </p>
                </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full border-t items-center justify-center px-4 md:px-6">
        <p className="text-center text-sm text-muted-foreground">© 2025 无忧直聘.</p>
      </footer>
    </div>
  )
}
